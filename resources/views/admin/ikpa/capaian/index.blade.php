            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="/admin/ikpa/capaian/add" class="btn btn-primary btn-sm">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size:14px">
                            ...
                            <td>
                                ...
                                <a href="/admin/ikpa/capaian/edit/{{$item->id}}" class="btn btn-sm btn-success">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="/admin/ikpa/capaian/delete/{{$item->id}}" class="btn btn-sm btn-danger"
...
<script>
    ...
    function insertAllSkpd(button) {
        ...
        if (confirm(`Apakah Anda yakin ingin memasukkan semua SKPD untuk tahun ${tahun}?`)) {
            ...
            // Send AJAX request
            fetch('/admin/ikpa/capaian/insert-all-skpd', {
                method: 'POST',
                headers: {
    ...
    function deleteAllSkpd(button) {
        ...
        if (confirm(`Apakah Anda yakin ingin menghapus SEMUA data SKPD untuk tahun ${tahun}? Tindakan ini tidak dapat dibatalkan!`)) {
            ...
            // Send AJAX request
            fetch('/admin/ikpa/capaian/delete-all-skpd', {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
